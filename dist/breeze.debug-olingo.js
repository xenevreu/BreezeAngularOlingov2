 ...
 *
 * Author: Jay Traband - Modified by Ivan Vargas
 */
  ...
  proto.executeQuery = function (mappingContext) {
    ...
    OData.read({
        ...
        function (data, response) {
          ...
          //seguindo o pull request do git https://github.com/Breeze/breeze.js/pull/41
          var resultado = null;
          if (data.results){
          ...
          return deferred.resolve({ results: resultado, inlineCount: inlineCount, httpResponse: response });
        },
        function (error) {
    ...
    OData.request({
      ...
      data.__batchResponses.forEach(function (br) {
        br.__changeResponses.forEach(function (cr) {
          ...
          //Ivan - bug do Olingo - O Content-Id é lowercase
          //seguindo o pull request do git https://github.com/Breeze/breeze.js/pull/41
          if (!contentId){
